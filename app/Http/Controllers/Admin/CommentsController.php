...
class CommentsController extends Controller {
    ...
    {
        $comments = Comments::with("user")->with("products")->get();
...
$products = Products::pluck("id", "id")->prepend('Please select', null);

	    
        $showhide = Comments::$showhide;

	    return view('admin.comments.create', compact("user", "products", "showhide"));
	}
...
$products = Products::pluck("id", "id")->prepend('Please select', null);
		...
		return view('admin.comments.edit', compact('comments', "user", "products", "showhide"));
	}
